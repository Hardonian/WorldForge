...
- Browser-based Simulation Studio with live runs, charts, audit logs, comparisons, benchmarks, proof inspection, and JSON export
...
- Simulation requests run in local server threads and are not persisted by the dashboard server.
